...
// API key is read from local.properties (gitignored) so secrets stay off source control.
...
dependencies {
    ...
    // Coil provides disk/memory image caching for weather icons
    implementation("io.coil-kt:coil-compose:2.5.0")

    // Location (lat/lon weather lookup when permission is granted)
